...
def new_pitch():
    '''
  View new pitch page function that returns the new created pitches
  '''
    form = PitchForm()
...
def upvote(pitch_id):
  """
  View upvote function that returns the upvotes on a particular quote
  """
  pitch = Pitch.query.get(pitch_id)
  user = current_user
...
def downvote(pitch_id):
  """
  View downvote function that returns the downvotes on a particular quote
  """
  pitch = Pitch.query.get(pitch_id)
  user = current_user
...
def update_profile(uname):
  """
  View update profile page function that returns a users updated profile
  """
  user = User.query.filter_by(username = uname).first()
...
def update_pic(uname):
  """
  View update profile pic page function that returns a users updated profile picture
  """
  user = User.query.filter_by(username = uname).first()
